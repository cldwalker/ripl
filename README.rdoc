...
commands i.e. {ripl-play}[https://github.com/cldwalker/ripl-play].  This customizability makes it
easy to build custom shells (i.e. for a gem or application) and complex shells (i.e. for the
{web}[https://github.com/cldwalker/nirvana]). In other words, ripl is also a shell framework. Works
...
* Enhancements over irb
  ...
  * ~/.irbrc errors caught
  * Well-integrated internationalization (see {ripl-i18n}[https://github.com/cldwalker/ripl-i18n])
* Different from irb
  ...
  * Some IRB.conf features aren't supported yet (see {ripl-irb}[https://github.com/cldwalker/ripl-irb]
    for details)
...
see {ripl-rails}[https://github.com/cldwalker/ripl-rails].
...
* {ripl-multi_line}[https://github.com/janlelis/ripl-multi_line] : evaluate multiple lines
* {ripl-ripper}[https://github.com/cldwalker/ripl-ripper] : evaluate multiple lines with ripper
* {ripl-rails}[https://github.com/cldwalker/ripl-rails] : console for rails
* {ripl-rack}[https://github.com/cldwalker/ripl-rack] : console for rack
* {ripl-play}[https://github.com/cldwalker/ripl-play] : play back and record input into ripl
* {ripl-debug}[https://github.com/cldwalker/ripl-debug] : automatically debugs a failed eval
* {ripl-after_rc}[https://github.com/cldwalker/ripl-after_rc] : provide blocks to run after ~/.irbrc is loaded
* {ripl-irb}[https://github.com/cldwalker/ripl-irb] : smooths transition from irb
* {ripl-i18n}[https://github.com/cldwalker/ripl-i18n] : translates ripl to your language
* {ripl-commands}[https://github.com/cldwalker/ripl-commands] : adds ripl commands similar to irb's commands
* {ripl-color_error}[https://github.com/cldwalker/ripl-color_error] : colorize errors
* {ripl-color_streams}[https://github.com/janlelis/ripl-color_streams] : colorizes stderr + stdout
* {ripl-color_result}[https://github.com/janlelis/ripl-color_result] : colorizes results
* {ripl-auto_indent}[https://github.com/janlelis/ripl-auto_indent] : auto indents multi-line input
* {ripl-hirb}[https://github.com/cldwalker/hirb] : comes with hirb to make it a proper riplzen
* {ripl-hijack}[https://github.com/cldwalker/ripl-hijack] : ripl console to a ruby process
* {ripl-misc}[https://github.com/cldwalker/ripl-misc] : a playground for ripl plugins
...
* {nirvana}[https://github.com/cldwalker/nirvana]: A ruby web shell complete with autocomplete
* {fresh}[https://github.com/janlelis/fresh]: An interesting ruby/system hybrid shell
* {ripl-johnson}[https://github.com/cldwalker/ripl-johnson]: A js shell based on johnson (firefox tracemonkey)
* {ronin}[https://github.com/ronin-ruby/ronin]: An exploit development platform using ripl for its console
* {tux}[https://github.com/cldwalker/tux]: A sinatra shell
...
* {ir}[https://github.com/raggi/ir]: nice and light
* {irb2}[https://github.com/wycats/irb2]: yehuda katz's partial attempt at rewriting irb
* {dietrb}[https://github.com/alloy/dietrb]: mac and ruby 1.9 specific
* {pry}[https://github.com/banister/pry]: featureful but heavy
