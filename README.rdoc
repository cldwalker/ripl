...
To view ripl's documentation online, read [the source](https://github.com/cldwalker/ripl/blob/master/man/ripl.1.ronn)
or [the html version](https://rawgit.com/cldwalker/ripl/master/man/ripl.1.html).
